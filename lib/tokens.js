...
exports.eofTok = exports.ignoreTok = exports.commaTok = exports.parenRTok = exports.parenLTok = exports.bracketDRTok = exports.bracketDLTok = exports.bracketRTok = exports.bracketLTok = exports.colonTok = exports.bangTok = exports.dotTok = exports.starTok = exports.nameTok = void 0;
...
var nameTok = TokenType("name", {
  expectNext: function expectNext(next) {
    return next === dotTok || next === commaTok || next === eofTok || next === bracketRTok || next === parenRTok || next === colonTok;
  }
});
...
var dotTok = TokenType(".", {
  ...
  expectPrev: function expectPrev(prev) {
    return prev === nameTok || prev === bracketDRTok || prev === starTok || prev === parenRTok || prev === bracketRTok;
  }
});
